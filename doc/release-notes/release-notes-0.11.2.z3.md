...
Nathan Wilcox (4):
      ...
      Add a commercium-gtest binary to our build with a single tautological test.
      Add coverage support scoped to only the commercium-gtest run; invoke with make commercium-cov; make cov is a superset.
...
Sean Bowe (49):
      ...
      Move incremental merkle tree tests to commercium-gtest.
      ...
      Small nit fixes
      Run `commercium-gtest` in `make check` and fix performance tests.
      ...
      Introduce new `libzcash` Commercium protocol API and crypto constructions surrounding the zkSNARK circuit.
      ...
      Rename COMMERCIUM_ constants to ZC_.
...
Taylor Hornby (7):
      ...
      Fix RPC tests
      Rename bitcoin.conf and bitcoind.pid to commercium.conf and commerciumd.pid in qa/ and src/
