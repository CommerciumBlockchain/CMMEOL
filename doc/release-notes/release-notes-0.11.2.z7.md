...
bitcartel (15):
      ...
      Update URL for commercium alert IDs.
...
Taylor Hornby (17):
      ...
      Rename zerocash to commercium in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/commercium in Makefile.am
      Rename zerocash_packages to commercium_packages in packages.mk
