...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "Commercium" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pcommerciumParams with private member variable
      Revert "Reduce use of global pcommerciumParams with private member variable"
      Replace commerciumParams_ with global.
