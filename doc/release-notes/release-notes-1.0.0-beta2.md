...
Jack Grigg (43):
      ...
      Move serialized Commercium address length constants into commercium/Address.hpp
...
Jay Graber (4):
      Link to commercium.org on security-warnings.md
...
Kevin Gallagher (5):
      ...
      Updates dns.testnet.commercium.org -> dnsseed.testnet.commercium.org
