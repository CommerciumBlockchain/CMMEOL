...
Bruno Arueira (1):
      Removes out bitcoin mention in favor for commercium
...
Jason Davies (1):
      Replace "bitcoin" with "Commercium".

Jay Graber (1):
      s/commercium/Commercium
...
Simon Liu (7):
      Replace 'bitcoin address' with 'commercium address'.
      Closes #2639. z_shieldcoinbase is now supported, no longer experimental.
      Closes #2263 fixing broken pipe error.
      Closes #2576. Update link to security info on commercium.org website.
