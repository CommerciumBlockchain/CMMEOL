...
Jack Grigg (11):
      ...
      Adjust gen-manpages.sh for Commercium, use in Debian builds
      Regenerate and collate Commercium manpages, delete Bitcoin ones
      Update release process with gen-manpages.sh
      Adjust blockheaderToJSON() for Commercium block header
      Adjust fundrawtransaction RPC test for Commercium
      Re-encode t-addrs in disablewallet.py with Commercium prefixes
      BTC -> CMM in paytxfee RPC docs
