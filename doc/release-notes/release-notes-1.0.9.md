...
Jack Grigg (14):
      ...
      Convert Commercium versions to Debian format
      ...
      Implement automatic shutdown of deprecated Commercium versions
...
Jay Graber (2):
      Change help text examples to use Commercium addresses
...
Nathan Wilcox (39):
      ...
      Add all of the commercium release tags in my current repo as positive test vector.
      ...
      Reuse commercium_rpc.
      Do not use `-rpcwait` on all `commercium_rpc` invocations, only block when starting commerciumd.
...
emilrus (1):
      Replace bitcoind with commerciumd
