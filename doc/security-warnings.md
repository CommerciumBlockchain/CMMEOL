...
Commercium has been subjected to a formal third-party security review. For security
announcements, audit results and other general security information, see
https://commercium.org/support/security.html
...
This implementation of Commercium is not resistant to side-channel attacks. You
should assume (even unprivileged) users who are running on the hardware, or who
are physically near the hardware, that your `commerciumd` process is running on will
be able to:
...
unprivileged) on the hardware your `commerciumd` process runs on until these
...
in [issue #826](https://github.com/commercium/commercium/issues/826), and believe that we
