...
# This script tests that the package mirror at https://commercium.org/depends-sources/
# contains all of the packages required to build this version of Commercium.
#
# This script assumes you've just built Commercium, and that as a result of that
...
MIRROR_URL_DIR="https://commercium.org/depends-sources/"
