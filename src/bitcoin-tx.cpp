...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Commercium commercium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  commercium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded commercium transaction") + "\n" +
              "  commercium-tx [options] -create [commands]   " + _("Create hex-encoded commercium transaction") + "\n" +
              "\n";
