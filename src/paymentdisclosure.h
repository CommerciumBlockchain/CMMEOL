...
#ifndef COMMERCIUM_PAYMENTDISCLOSURE_H
#define COMMERCIUM_PAYMENTDISCLOSURE_H
...
struct PaymentDisclosureInfo {
    ...
    uint256 esk;              // commercium/NoteEncryption.cpp
...
struct PaymentDisclosurePayload {
    ...
    libzcash::SproutPaymentAddress zaddr; // commercium/Address.hpp
...
#endif // COMMERCIUM_PAYMENTDISCLOSURE_H
