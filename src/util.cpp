...
int nCommerciumSendRounds = 10;
int nAnonymizeCommerciumAmount = 1000;
int nLiquidityProvider = 0;
/** Spork enforcement enabled time */
int64_t enforceMasternodePaymentsTime = 4085657524;
bool fSucessfullyLoaded = false;
bool fEnableCommerciumSend = false;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Commercium
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Commercium
...
{
    // Copied from GetDefaultDataDir and adapter for commercium params.

    namespace fs = boost::filesystem;
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\CommerciumParams
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\CommerciumParams
    // Mac: ~/Library/Application Support/CommerciumParams
    // Unix: ~/.commercium-params
#ifdef WIN32
    // Windows
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2017-%i The Commercium developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
